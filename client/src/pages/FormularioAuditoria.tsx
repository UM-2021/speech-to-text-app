...
import { IonAvatar, IonChip, IonItem, IonContent, IonSegment, IonSegmentButton,IonListHeader, IonList, IonImg, IonIcon, IonInput, IonButton, IonPage, IonHeader, IonTitle, IonToolbar, IonSelect, IonSelectOption, IonFooter, IonItemDivider, IonLabel } from '@ionic/react';
...
const FormularioAuditoria = () => {
    return (
        <IonPage>
            ...
            <IonFooter>
                <IonItem>
                    <IonButton size="large" slot="start" color="danger" expand='block'>Cancel</IonButton>
                    <IonButton size="large" slot="end"expand='block'>Guardar</IonButton>
                </IonItem>
            </IonFooter>
        </IonPage>
